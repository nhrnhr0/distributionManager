...
from dashboard.views import dashboard_leads_in,dashboard_index,dashboard_messages,dashboard_message_edit
...
urlpatterns = [
    ...
    path('dashboard/messages/<str:uid>/edit/', dashboard_message_edit, name='message_edit'),
